...
const Header: React.FC<HeaderProps> = ({ 
  ...
  const navLinks = [
    ...
    { page: 'licensing', key: 'licensing' }
    // FAQ removed from navigation as per request
  ];
    ...
    <>
      <header className="bg-primary text-accent-light shadow-md sticky top-0 z-40">
        <div className="container mx-auto flex justify-between items-center px-4 h-20">
          ...
          {/* Desktop Nav Removed - Replaced by Burger Menu for all screens */}
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-primary-dark/95 backdrop-blur-sm z-50 flex flex-col items-center justify-center"
